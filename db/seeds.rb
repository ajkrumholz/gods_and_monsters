...
@harpies = @slaanesh.monsters.create!(name: "Harpies", strength_rank: 4.5, flying: true)
...
@marauders = @nurgle.monsters.create!(name: "Marauders", strength_rank: 4.0, flying: false)
